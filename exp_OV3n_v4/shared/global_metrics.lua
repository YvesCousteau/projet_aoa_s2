_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = "6.15",
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = "6.15",
    speedup_if_clean = "1.18",
    innerloops_time = 100,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 0.13 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.13 seconds.",
