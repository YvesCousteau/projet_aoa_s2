_report = {
  metrics = {
    ...
    compilation_flags = "binary: GNU 10.2.0 -mtune=generic -march=x86-64 -g -O2 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.08,
    speedup_if_fp_vect = "1.19",
    ...
    speedup_if_fully_vectorised = "6.04",
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = "6.04",
    speedup_if_clean = "1.23",
    innerloops_time = 99.08,
    array_access_efficiency = "95.83",
    profiled_time = 0.11,
    nb_processes = 1,
    crest_performance = "Not Implemented Yet",
    nb_threads = 1,
    application_time = 0.11,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 0.11 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.11 seconds.",
