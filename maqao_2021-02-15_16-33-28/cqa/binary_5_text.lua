_cqa_text_report = {
  paths = {
    ...
    },
    {
      ...
      expert = {
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 1568\n\nInstruction         | Nb FU | P0   | P1   | P2 | P3 | P4 | P5   | P6   | P7 | Latency | Recip. throughput\n---------------------------------------------------------------------------------------------------------\nTEST %EAX,%EAX      | 1     | 0.25 | 0.25 | 0  | 0  | 0  | 0.25 | 0.25 | 0  | 1       | 0.25\nJS 1595 <s13+0x65>  | 1     | 0.50 | 0    | 0  | 0  | 0  | 0    | 0.50 | 0  | 0       | 0.50-1\nCMP %EAX,%EDI       | 1     | 0.25 | 0.25 | 0  | 0  | 0  | 0.25 | 0.25 | 0  | 1       | 0.25\nJBE 1595 <s13+0x65> | 1     | 0.50 | 0    | 0  | 0  | 0  | 0    | 0.50 | 0  | 0       | 0.50-1\nADD $0x1,%EAX       | 1     | 0.25 | 0.25 | 0  | 0  | 0  | 0.25 | 0.25 | 0  | 1       | 0.25\nADD $0x4,%RDX       | 1     | 0.25 | 0.25 | 0  | 0  | 0  | 0.25 | 0.25 | 0  | 1       | 0.25\nCMP %EAX,%ESI       | 1     | 0.25 | 0.25 | 0  | 0  | 0  | 0.25 | 0.25 | 0  | 1       | 0.25\nJNE 1568 <s13+0x38> | 1     | 0.50 | 0    | 0  | 0  | 0  | 0    | 0.50 | 0  | 0       | 0.50-1\n",
        },
        {
          title = "General properties",
    ...
    },
    {
      hint = {
        {
          workaround = "Recompile with march=skylake.\nCQA target is Skylake but compiler target is ",
  ...
  common = {
    header = {
      "The loop is defined in /home/hugohenrotte/Code/projet_aoa_s2/kernel.c:7-14.\n",
