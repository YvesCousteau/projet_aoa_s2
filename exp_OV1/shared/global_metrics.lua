_report = {
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 0.04 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.04 seconds.",
