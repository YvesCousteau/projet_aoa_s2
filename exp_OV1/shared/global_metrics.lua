_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = "7.77",
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = "7.77",
    speedup_if_clean = "1.51",
    innerloops_time = 100,
    array_access_efficiency = "83.33",
    profiled_time = 0.73,
    number_processes = 1,
    crest_performance = "Not Implemented Yet",
    nb_threads = 1,
    application_time = 0.73,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 0.73 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.73 seconds.",
