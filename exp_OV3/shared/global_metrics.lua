_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = "5.95",
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = "3.98",
    speedup_if_clean = "1.20",
    innerloops_time = 88.89,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 0.05 seconds.",
