_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = "6.34",
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = "6.34",
    speedup_if_clean = "1.24",
    innerloops_time = 100,
  ...
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.09 seconds.",
